...
- "wpackagist-plugin/filebird": "6.4.9"
...
## [v2.7.3] - 2024-08-29
### Changed
- "cul-it/advanced-custom-fields-pro": "6.3.6",
- "wpackagist-plugin/custom-post-type-ui": "1.17.1",
- "wpackagist-plugin/json-content-importer": "1.6.1",

## [v2.7.2] - 2024-08-26
### new version to test deploy
...
## [v2.6.4] - 2024-04-09
- update defined symbol in wp-config.php for php 8.1
...
## [v2.4.8] = 2024-02-08
- "cul-it/wp-ultimate-csv-importer-pro": "v7.8.4.5",

## [v2.4.7] - 2024-02-08
- "cul-it/wp-ultimate-csv-importer-pro": "v7.8.4.2",

## [v2.4.6] - 2024-02-08
- "cul-it/wp-ultimate-csv-importer-pro": "v7.8.4.1",
...
## [v2.3.27] - 2023-05-19
- "wpackagist-plugin/elementor": "3.13.2"

## [v2.3.26] - 2023-05-18
- "cul-it/elementor-pro": "3.13.1"
- "cul-it/facetwp": "4.2.0"
- "cul-it/facetwp-conditional-logic": "1.4.2"
- "pantheon-systems/wordpress-composer": "6.2.1"
- "wpackagist-plugin/capability-manager-enhanced": "2.8.1"
- "wpackagist-plugin/filebird": "5.3.2"
- "wpackagist-plugin/relevanssi": "4.20.0"
...
## [v2.3.23] - 2023-05-10
- patch Draw Attention Pro for class name case issue - 3.0.7.1
...
## [v2.3.20] - 2023-05-04
- make path relative in for certdir
...
- [CULU update v1.6.12](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.6.12)

## [v2.2.6] - 2023-01-18
### Changed
- [CULU update v1.6.11](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.6.11)

## [v2.2.5] - 2023-01-17
### Changed
- [CULU update v1.6.9](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.6.9)
...
## [v2.2.2] - 2022-11-07
### Changed
- [Code Snippets v3.2.1](https://wordpress.org/plugins/code-snippets/)
- [FileBird Lite v5.0.8](https://wordpress.org/plugins/filebird/)
- [FacetWP v4.1.1](https://github.com/cul-it/facetwp/releases/tag/v4.1.1)
...
- [WP SAML Auth v1.2.5](https://wordpress.org/plugins/wp-saml-auth/)
- pear/archive_tar 1.4.13 conflicts with roave/security-advisories - [pear/archive_tar 1.4.14](https://github.com/advisories/GHSA-rpw6-9xfx-jvcx)
-
## [v1.8.0] -  2021-08-20
### Changed
...
## [v1.7.9] - 2021-07-09
- [Elementor Pro v3.3.1.1](https://github.com/cul-it/elementor-pro/blob/master/changelog.txt) - rebuild version by rolling back to 3.2.1 then rebuilding from download of 3.3.1
- uncoment test in site-basics.feature
...
## [v1.7.3] - 2021-05-12
### Changed
- [Elementor v3.2.3](https://wordpress.org/plugins/elementor/)
- [Elementor Pro v3.2.2](https://github.com/cul-it/elementor-pro/blob/master/changelog.txt)
- [PublishPress Capabilities v2.0.2](https://wordpress.org/plugins/capability-manager-enhanced/)
- [Relevanssi v4.13.1](https://wordpress.org/plugins/relevanssi/)
- [Distributor v1.6.4](https://github.com/10up/distributor/blob/develop/CHANGELOG.md)
- [CULU Theme v1.5.5](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.5.5)
...
- [Coming Soon Page & Maintenance Mode v6.2.0](https://wordpress.org/plugins/coming-soon/#developers)
...
- [CULU theme v1.2.0](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.2.0)
...
- [CULU theme v1.1.9](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.9)

## [v1.3.12] - 2020-05-16
### Changed
- [CULU theme v1.1.8](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.8)
...
- [CULU theme v1.1.7](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.7)
...
- [CULU theme v1.1.6](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.6)
...
- [CULU theme v1.1.5](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.5)
...
## [v1.3.6]
### Changed
- [CULU theme v1.1.4](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.4)


## [v1.3.5]
### Changed
- [CULU theme v1.1.3](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.3)
- capability-manager-enhanced - 1.9 -> 1.9.2 - see [Changelog](https://wordpress.org/plugins/capability-manager-enhanced/#developers)
...
## [v1.3.3]
### Changed
- [CULU theme v1.1.2](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.2)
...
## [v1.3.2]
### Changed
- [CULU theme v1.1.1](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.1)
- update nokogiri for Security advisory GHSA-7553-jr98-vx47

## [v1.3.1] -- 2020-02-20
### Changed
- [CULU theme v1.1.0](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.1.0)
...
- [CULU theme v1.0.32](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.32)
...
- [CULU theme v1.0.31](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.31)
...
## [v1.2.34] - 2019-12-06
### Changed
- [CULU theme v1.0.29](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.29)
...
- [CULU theme v1.0.28](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.28)
...
- [CULU theme v1.0.27](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.27)
...
## [v1.2.30] - 2019-11-22
### Changed
- [CULU theme v1.0.26](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.26)
...
## [v1.2.27] - 2019-11-08
### Changed
- [CULU theme v1.0.25](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.25)
...
- [CULU theme v1.0.24](https://github.com/cul-it/wp-cul-theme-culu/releases/tag/v1.0.24)
...
[v1.2.30]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.30
[v1.2.29]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.29
[v1.2.28]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.28
[v1.2.27]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.27
[v1.2.26]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.26
[v1.2.25]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.25
[v1.2.24]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.24
[v1.2.23]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.23
[v1.2.22]: https://github.com/cul-it/ci-jenkins-pantheon-wordpress/releases/tag/v1.2.22
