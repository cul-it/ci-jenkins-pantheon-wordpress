...
The next generation of the AAM v6 is here. You can download the beta version from the [Official WordPress Repository](https://downloads.wordpress.org/plugin/advanced-access-manager.6.0.0-beta.1.zip).
