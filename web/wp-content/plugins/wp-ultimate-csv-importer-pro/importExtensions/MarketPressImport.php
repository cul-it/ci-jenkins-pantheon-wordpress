...
class MarketPressImport {
    ...
    public function marketpress_meta_import_function($data_array, $pID , $type , $line_number) {
		...
		if ( in_array( 'wordpress-ecommerce/marketpress.php', $extension_instance->get_active_plugins() ) && $type == 'MarketPress Product' ) {
        ...
        elseif ( in_array( 'wordpress-ecommerce/marketpress.php', $extension_instance->get_active_plugins() ) && $type == 'MarketPress Product Variations' ) {
