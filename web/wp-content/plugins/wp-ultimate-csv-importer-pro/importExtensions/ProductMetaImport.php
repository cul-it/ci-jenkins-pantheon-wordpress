...
class ProductMetaImport {
    ...
    function set_product_meta_values($header_array ,$value_array , $map , $post_id ,$type , $line_number , $mode , $core_map){
        global $wpdb;
        ...
        if(($type == 'WooCommerce Product') || ($type == 'WooCommerce Product Variations') || ($type == 'WooCommerce Orders') || ($type == 'WooCommerce Coupons') || ($type == 'WooCommerce Refunds')){
            $woocommerce_meta_instance->woocommerce_meta_import_function($data_array, $post_id , $type , $line_number , $mode, $header_array, $value_array , $core_array);
        }
