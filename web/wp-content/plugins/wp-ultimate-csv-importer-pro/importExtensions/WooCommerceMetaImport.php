...
class WooCommerceMetaImport {
	...
	public function woocommerce_meta_import_function ($data_array, $image_meta, $pID , $import_type , $line_number , $mode, $header_array , $value_array , $core_array) {
		global $wpdb;
