...
class ExtensionHandler{
	...
	public function set_post_types($hashkey , $filename) {
		...
		if($file_extension == 'xml'){
			...
			$Headers = array_keys($xml_arr[$child_name][0]); 
			$type = $this->select_import_type($Headers);
		...
		$type = 'Posts';
						...
						elseif( in_array('location_name', $Headers) || in_array('location_address', $Headers)){
							...
							if(in_array('advanced-custom-fields/acf.php', $this->get_active_plugins())) {
								$type = 'acf-field';
							} elseif( in_array('advanced-custom-fields-pro/acf.php', $this->get_active_plugins())) {
							...
							$type = 'category';
						} elseif(in_array('woocommerce/woocommerce.php', $this->get_active_plugins())){
						...
						} elseif(in_array('wordpress-ecommerce/marketpress.php', $this->get_active_plugins()) || in_array('marketpress/marketpress.php', $this->get_active_plugins())){
						...
						} elseif(in_array('wp-e-commerce/wp-shopping-cart.php', $this->get_active_plugins())){
