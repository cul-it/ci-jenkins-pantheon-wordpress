...
class ACFGalleryMetaExtension extends ExtensionHandler{
	private static $instance = null;

    public static function getInstance() {
		
		if (ACFGalleryMetaExtension::$instance == null) {
			ACFGalleryMetaExtension::$instance = new ACFGalleryMetaExtension;
		}
		return ACFGalleryMetaExtension::$instance;
	}
	
	/**
	* Provides ACF Gallery Meta mapping fields for specific post type
	...
	*/
    public function processExtension($data) {
        ...
        $acf_image_meta_Fields = array(
			        'Caption' => 'acf_gallery_caption',
					'Alt text' => 'acf_gallery_alt_text',
					'Description' => 'acf_gallery_description',
					'File Name' => 'acf_gallery_file_name',
					'Title' => 'acf_gallery_title',
        );
		$acf_image_meta_value = $this->convert_static_fields_to_array($acf_image_meta_Fields);
		$response['acf_gallery_meta_fields'] = $acf_image_meta_value ;
		return $response;
		
    }

	/**
	* ACF Gallery Meta mapping fields extension supported import types
