...
class AllInOneSeoExtension extends ExtensionHandler{
	...
	*/
    public function extensionSupportedImportType($import_type){
		if(in_array('all-in-one-seo-pack/all_in_one_seo_pack.php' , $this->get_active_plugins()) || in_array('all-in-one-seo-pack-pro/all_in_one_seo_pack.php' , $this->get_active_plugins())){
