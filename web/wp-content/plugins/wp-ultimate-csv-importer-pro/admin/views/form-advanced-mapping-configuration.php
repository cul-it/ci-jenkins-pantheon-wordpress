                                    ...
                                    <tr class="wp_ultimate_container">
                                       <td>
                                          ...
                                          <div class="form-group wp_ultimate_container">
                                             ...
                                             <label class="control-label col-md-12"><input name="CORE__is_post_status" id="post_status_csv" data-key="true" class="wp_ultimate_slide" type="radio">Set with <?php echo $setwith; ?> </label>
                                    ...
                                    <tr class="wp_ultimate_container">
                                       <td>
                                          ...
                                          <div class="form-group wp_ultimate_container">
                                             ...
                                             <label class="control-label col-md-12"><input name="CORE__post_comment_status" id="post_comments_csv" data-key="true" class="wp_ultimate_slide" type="radio" value="set_from_csv">Set with <?php echo $setwith; ?> </label>
                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <div class="form-group wp_ultimate_container">
                                             ...
                                             <label class="control-label col-md-12"><input name="CORE__post_ping_status" id="ping_status_csv" data-key="true" class="wp_ultimate_slide" type="radio">Set with <?php echo $setwith; ?> </label>
                                          ...
                                          <td>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <label class="control-label col-md-12 pl0"><input id="post_format_csv" class="wp_ultimate_slide" data-key="true" name="CORE__post_format_option" value="xpath" type="radio">
                                                   Set with <?php echo $setwith; ?> </label>
