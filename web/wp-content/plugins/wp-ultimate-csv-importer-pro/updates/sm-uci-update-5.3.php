...
$tables = array("CREATE TABLE IF NOT EXISTS `wp_ultimate_csv_importer_scheduled_export` (
...
$wpdb->query("alter table wp_ultimate_csv_importer_scheduled_import modify column `cron_status` varchar(15) DEFAULT 'pending'");
