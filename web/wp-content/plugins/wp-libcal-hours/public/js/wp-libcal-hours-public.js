  ...
  libcalInit: function () {
    if (typeof lid_weekly != 'undefined') {
      ...
      for (var i = 0; i < lid_weekly.length; ++i) {
          ...
          var week = new $.LibCalWeeklyGrid( $("#libcal-weekly-hours"), { iid: 973, lid: libcal_lid[i],  weeks: 52, systemTime: false });
      }
    }
    if(typeof lid_monthly != 'undefined'){
      ...
      var month = new $.LibCalHoursCal( $("#libcal-monthly-hours"), { iid: 973, lid: library_id, months: 12, systemTime: false });
    }
    if (typeof lid_combined != 'undefined') {
      ...
      var weeks = new $.LibCalWeeklyGrid( $("#libcal-weekly-hours"), { iid: 973, lid: libcal_library_id,  weeks: 52, systemTime: false });
      var months = new $.LibCalHoursCal( $("#libcal-monthly-hours"), { iid: 973, lid: libcal_library_id, months: 12, systemTime: false });
    }
  },
