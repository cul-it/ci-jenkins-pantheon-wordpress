...
jQuery(document).ready(function ($) {
	...
	$('.ai1wm-backups').on('click', '.ai1wm-add-description, .ai1wm-backup-label', function () {
		$(this).hide();
		...
		if (!$(this).closest('td').find('.ai1wm-add-label-holder').length) {
			...
			td.append('\n\t\t\t\t<tr class="ai1wm-add-label-holder">\n\t\t\t\t\t<td>\n\t\t\t\t\t\t<input type="text" class="ai1wm-label-field" value="' + backup_label.text().trim() + '" />\n\t\t\t\t\t</td>\n\t\t\t\t</tr>\n\t\t\t');
	...
	$(document).on('keypress keydown', '.ai1wm-label-field', function (e) {
