...
Import.prototype.hasEnoughDiskSpace = function (backupSize) {
	if (ai1wm_disk_space.free && backupSize) {
...
Import.prototype.getNoDiskSpaceMessage = function (backupSize) {
	var requiredDiskSpace = backupSize * ai1wm_disk_space.factor + parseInt(ai1wm_disk_space.extra, 10);
	var additionalDiskSpaceText = Ai1wm.Util.sizeFormat(requiredDiskSpace - ai1wm_disk_space.free);

	return ai1wm_locale.out_of_disk_space.replace('%s', additionalDiskSpaceText);
};
