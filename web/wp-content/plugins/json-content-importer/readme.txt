...
* Placeholders for template: If you want tohave curly or square brackets {}[] in the template this can trouble the shortcode-syntax and the parser of the template. Use the placeholders #CBO# (curly brackets open), #CBC# (curly brackets close), #SBO# (square brackets open) and #SBC# (square brackets close) in the temaplte, the placeholders will be replaced by it'S needed values in the end after parsing   
