<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="metadata">
      ...
      <p><?php if (!empty(get_field('publication_year'))) : ?>Pub year: <?php echo the_field('publication_year'); endif; ?></p>
      <p><?php if (!empty(get_field('bibid'))) : ?>Access: <a href="https://newcatalog.library.cornell.edu/catalog/<?php echo the_field('bibid'); ?>"><?php echo the_field('bibid'); ?></a><?php endif; ?></p>
      <p><?php if (!empty(get_field('isbn'))) : ?>ISBN: <?php echo the_field('isbn'); endif; ?></p>
    </div>
  </div>
</div>