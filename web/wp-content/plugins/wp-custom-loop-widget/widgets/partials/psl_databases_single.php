<div class="card">
  <div class="card-body">
    ...
    <div class="metadata">
      <p class="description">
        <?php if (!empty(get_field('bibid'))) : ?>Catalog: <a href="https://newcatalog.library.cornell.edu/catalog/<?php echo the_field('bibid'); ?>"><?php echo the_field('bibid'); ?></a><br /><?php endif; ?></p>
