  ...
  <section class="database-list" aria-label="<?php echo the_field('title'); ?>">
    <div class="card-body">
      ...
      <div class="database-metadata">
        ...
        <?php endif; ?>
        <?php if (!empty(get_field('afr')) || !empty(get_field('barcode'))) : ?>
          <div>
            <div class="description">
              <?php if (!empty(get_field('barcode'))) : ?>Barcode no. <?php echo the_field('barcode'); ?><?php endif; ?><?php if (!empty(get_field('barcode')) && !empty(get_field('afr'))) : ?>: <?php endif; ?><?php if (!empty(get_field('afr'))) : ?><strong><?php if (!empty(get_field('call_number'))) : ?><a href="https://newcatalog.library.cornell.edu/catalog/<?php echo the_field('call_number'); ?>"><?php endif; ?><?php echo the_field('afr'); ?><?php if (!empty(get_field('call_number'))) : ?></a><?php endif; ?></strong><?php endif; ?>
            </div>
          </div>
        <?php endif; ?>
      </div>
