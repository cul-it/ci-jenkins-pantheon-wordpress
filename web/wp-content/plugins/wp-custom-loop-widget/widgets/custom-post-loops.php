...
class Wp_Custom_Post_Loops extends Widget_Base
{
	...
	protected function _register_controls() {
		...
		$asia = [
			'asia_books_list' => __('Asia - Books List', 'CUL'),
			'asia_books_country' => __('Asia - Books Country Page', 'CUL'),
			'asia_bookchapters_list' => __('Asia - Book Chapters List', 'CUL'),
			'asia_bookchapters_country' => __('Asia - Book Chapters Country Page', 'CUL'),
			'asia_databases_list' => __('Asia - Databases List', 'CUL'),
			'asia_databases_country' => __('Asia - Databases Country Page', 'CUL'),
			'asia_resources_list' => __('Asia - Resources List', 'CUL'),
			'asia_resources_country' => __('Asia - Resources Country Page', 'CUL'),
			'asia_resources_combined' => __('Asia - Combined Resources List', 'CUL'),
			'asia_search_results' => __('Asia - Search Results', 'CUL'),
		];
		...
		$management = $management_opts;
		$johnson = $management_opts;

		$mann_opts = [
			'mann_news_list' => __('Mann/Olin/Uris - News List', 'CUL'),
			'mann_exhibits_list' => __('Mann/Olin/Uris - Exhibits List', 'CUL'),
		];
		$olinuris_opts = $mann_opts;
	...
	protected function render()
	{
		...
		elseif ($post_type_selection == "asia_books_list") :
			include_once 'partials/asia_books_list.php';
		elseif ($post_type_selection == "asia_books_country") :
			include_once 'partials/asia_books_country.php';
		elseif ($post_type_selection == "asia_bookchapters_list") :
			include_once 'partials/asia_bookchapters_list.php';
		elseif ($post_type_selection == "asia_bookchapters_country") :
			include_once 'partials/asia_bookchapters_country.php';
		elseif ($post_type_selection == "asia_databases_list") :
			include_once 'partials/asia_databases_list.php';
		elseif ($post_type_selection == "asia_databases_country") :
			include_once 'partials/asia_databases_country.php';
		elseif ($post_type_selection == "asia_resources_list") :
			include_once 'partials/asia_resources_list.php';
		elseif ($post_type_selection == "asia_resources_country") :
			include_once 'partials/asia_resources_country.php';
		elseif ($post_type_selection == "asia_resources_combined") :
			include_once 'partials/asia_resources_combined.php';
		elseif ($post_type_selection == "asia_search_results") :
			include_once 'partials/asia_search_results.php';
		...
		elseif ($post_type_selection == "mann_news_list") :
			include_once 'partials/mann_news_list.php';
		elseif ($post_type_selection == "mann_exhibits_list") :
			include_once 'partials/mann_exhibits_list.php';
