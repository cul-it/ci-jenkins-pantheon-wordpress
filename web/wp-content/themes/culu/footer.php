...
<footer>
    ...
    <div class="footer__nav">
      ...
      <div class="all-libraries">
        <a href="https://www.library.cornell.edu/libraries"><span class="fa fa-arrow-left" aria-hidden="true"></span> Libraries and Hours</a> | <a href="https://www.library.cornell.edu/ask/email">Ask a Librarian</a>
      </div>
    ...
    <address class="library">
        ...
        <div class="container">
          ...
          <div class="c-1">
            ...
            <a class="icon-map" href="<?php echo $google_map_label ?>" title="Library Location"> <i class="fas fa-map-marker-alt" aria-hidden="true"><span class="sr-only">Library Location</span></i></a></p>

            <?php } ?>

            <?php if( is_active_sidebar( 'widget-social-media' ) ) : ?>

              <aside class="widget-social-media">
