...
<footer>
    ...
    <div class="footer__nav">
        ...
        <div class="all-libraries">
            <a href="https://www.library.cornell.edu/libraries"><span class="fa fa-arrow-left"
                ...
                href="https://www.library.cornell.edu/ask">Ask a Librarian</a>
        </div>
        ...
        <div class="container">
                ...
                <p><strong><?php echo get_bloginfo( 'name' ); ?></strong><br>
                    ...
                    <a class="icon-map" href="<?php echo $google_map_label ?>" title="Library Location"> <i
                            class="fas fa-map-marker-alt" aria-hidden="true"><span
                                class="sr-only"><?php echo get_bloginfo( 'name' ); ?> Library Location</span></i></a>
                </p>
                <?php } ?>
            ...
            <div class="c-1">
                <p><strong><?php echo $contact_name_2; ?></strong><br>
                    ...
                    <a class="icon-map" href="<?php echo $google_map_label ?>" title="Library Location"> <i
                            class="fas fa-map-marker-alt" aria-hidden="true"><span
                                class="sr-only"><?php echo $contact_name_2; ?> Library Location</span></i></a></p>
                <?php } ?>
            </div>
            <div class="c-2 c2">
                <?php
    ...
    <address class="cornell">
        ...
        <p>©<?php echo date('Y'); ?> Cornell University Library, Ithaca, NY 14853 | 607-255-4144 | <a
