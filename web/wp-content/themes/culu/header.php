...
<body <?php body_class(); ?>>
    ...
    <section class="<?php if (is_front_page()) {
        ...
        <div class="all-libraries" role="region" aria-label="All library websites and hours, and ask a librarian links">
            ...
            <a href="https://www.library.cornell.edu/libraries"><span><i class="fas fa-arrow-left" aria-hidden="true"></i> Libraries and Hours</span></a><a href="https://www.library.cornell.edu/ask"><span><i class="far fa-comment-alt" aria-hidden="true"></i> Ask a Librarian</span></a>
            ...
            <div class="subheader">
                ...
                <div class="available-time">
                    ...
                    if ($lid_1 != NULL) :
                        ...
                        <i class="fas fa-clock icon-time" aria-hidden="true"><span class="sr-only">Library hours status</span></i>
                    ...
                    if ($lid_2 != NULL) :
                        ...
                        <br />
                    <?php endif; ?>
                    <?php if ($lid_2 == NULL) : ?> - <?php endif; ?><a class="full-hours" href="/full-hours">Full Hours</a> /
                    ...
                    <ul class="header-contact">
                        ...
                        <?php if (!empty($google_map_label)) { ?>
                            <li>
                                <a href="<?php echo $google_map_label ?>" title="Library location"><i class="fas fa-map-marker-alt" aria-hidden="true"><span class="sr-only">Library Location</span></i></a>
                            </li>
                        <?php } ?>
                    </ul>
                </div>
    ...
    <nav id="site-navigation" class="main-navigation" aria-label="Main navigation">
        ...
        <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false" title="Main Navigation" <?php //esc_html_e( 'Menu', 'culu' ); 
                                                                                                                ?>><i class="fas fa-bars" aria-hidden="true"><span class="screen-reader-text">Main Navigation</span></i></button>
        <?php
        wp_nav_menu(array(
