...
<body <?php body_class(); ?>>
	...
	<nav aria-label="Skip to content"><a class="skip-link screen-reader-text" href="#main-content"><?php esc_html_e( 'Skip to content', 'culu' ); ?></a></nav>
	...
	<header class="branding">
		...
		<div class="banding">
			...
			<a class="logo-cul" href="https://www.library.cornell.edu/" title="Cornell University Library website homepage"><img src="<?php echo get_template_directory_uri(); ?>/images/branding/cul-logo.svg" alt="Cornell University Library site"></a>
	...
	<section class="<?php if ( is_front_page() ) { echo 'hero__content'; } else { echo 'hero__content interior-pages'; } ?>" aria-label="Hero header">
		...
		<a href="https://www.library.cornell.edu/libraries"><span><i class="fas fa-arrow-left" aria-hidden="true"></i> Libraries and Hours</span></a><a href="https://www.library.cornell.edu/ask/email"><span><i class="far fa-comment-alt" aria-hidden="true"></i> Ask a Librarian</span></a>
			...
			<div class="subheader">
				...
				<?php get_template_part( 'template-parts/library-hours' ); ?>
					...
					<ul class="header-contact">
						...
						<li>
							<a href="<?php if (filter_var($email_label, FILTER_VALIDATE_EMAIL)) : ?>mailto:<?php echo $email_label ?><?php else : ?><?php echo $email_label ?><?php endif; ?>" title="Contact us"><i class="fas fa-envelope" aria-hidden="true"><span class="sr-only">Contact us</span></i></a>
						</li>
						...
						<li><a href="<?php echo $google_map_label ?>" title="Library location"><i class="fas fa-map-marker-alt" aria-hidden="true"><span class="sr-only">Library Location</span></i></a></li>
	...
	<nav id="site-navigation" class="main-navigation" aria-label="Main navigation">
		...
		<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false" title="Main Navigation" <?php //esc_html_e( 'Menu', 'culu' ); ?>><i class="fas fa-bars" aria-hidden="true"><span class="screen-reader-text">Main Navigation</span></i></button>
		<?php
		wp_nav_menu( array(
