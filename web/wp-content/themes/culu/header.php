...
<body <?php body_class(); ?> <nav aria-label="Skip to content"><a class="skip-link screen-reader-text" href="#main-content"><?php esc_html_e('Skip to content', 'culu'); ?></a></nav>
    ...
    <section class="<?php if (is_front_page()) {
        ...
        <div class="home-header" role="region" aria-label="Unit library header">
            ...
            <div class="subheader">
                ...
                <h1><a href="/"><?php echo (get_bloginfo('name')); ?></a><?php get_template_part('template-parts/college-logo-header'); ?>
                </h1>
    ...
    <nav id="site-navigation" class="main-navigation" aria-label="Main navigation">
        ...
        <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false" title="Main Navigation" <?php //esc_html_e( 'Menu', 'culu' ); 
                                                                                                                ?>><i class="fas fa-bars" aria-hidden="true"><span class="screen-reader-text">Main
                    Navigation</span></i></button>
        <?php
        wp_nav_menu(array(
