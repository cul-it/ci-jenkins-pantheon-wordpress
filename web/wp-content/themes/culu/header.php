	...
	<header class="branding" aria-label="Branding header">
		...
		<nav class="user-tools" aria-label="My account and Search navigation">
			...
			<ul>
				...
				<li><a href="https://www.library.cornell.edu/myacct" title="My account"><i class="fas fa-user" aria-hidden="true" aria-label="My account"></i></a></li>
				<li><button class="icon-search" title="Search"><i class="fas fa-search" aria-hidden="true" aria-label="Search"></i></button></li>
			</ul>
			...
			<div class="subheader">
				...
				<?php get_template_part( 'template-parts/library-hours' ); ?>
					...
					<ul class="header-contact">
						...
						<li><a href="https://www.library.cornell.edu/ask/email" title="Contact us"><i class="fas fa-envelope" aria-hidden="true" aria-label="Contact us"></i></a></li>

						<!--<li><a href=""><i class="fas fa-phone-square" aria-hidden title=""></i></a></li>-->

						<?php if ( !empty( $google_map_label  ) ) { ?>

						<li><a href="<?php echo $google_map_label ?>" title="Library location"><i class="fas fa-map-marker-alt" aria-hidden="true" aria-label="Library Location"></i></a></li>
