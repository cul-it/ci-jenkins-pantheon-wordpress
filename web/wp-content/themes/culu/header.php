...
<body <?php body_class(); ?>>
	...
	<nav aria-label="Skip to content"><a class="skip-link screen-reader-text" href="#main-content" aria-label="Skip to content"><?php esc_html_e( 'Skip to content', 'culu' ); ?></a></nav>
	...
	<header class="branding" aria-label="Branding header">
		...
		<div class="banding">
			...
			<a class="logo-cul" href="https://www.library.cornell.edu/" title="Cornell University Library website homepage"><img src="<?php echo get_template_directory_uri(); ?>/images/branding/cul-logo.svg" alt="Cornell University Library logo"></a>
			...
			<div class="subheader">
				...
				<?php get_template_part( 'template-parts/library-hours' ); ?>
					...
					<ul class="header-contact">
						...
						<li><a href="https://www.library.cornell.edu/ask/email" title="Contact us"><i class="fas fa-envelope" aria-hidden="true"><span class="sr-only">Contact us</span></i></a></li>
