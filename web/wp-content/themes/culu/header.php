...
if ($post_slug == 'staff-profiles') { ?>

<body <?php body_class('staff-page'); ?>;>
...
<?php
    ...
    <section class="<?php if (is_front_page()) {
        ...
        <div class="all-libraries" role="region"
            aria-label="All library websites and hours, and ask a librarian links">
            ...
            <a href="https://www.library.cornell.edu/libraries"><span><i class="fas fa-arrow-left"
                ...
                href="https://www.library.cornell.edu/ask"><span><i class="far fa-comment-alt"
        ...
        <div class="home-header" role="region" aria-label="Unit library header">
            ...
            <div class="subheader">
                ...
                <h1><a
                        href="/"><?php echo (get_bloginfo('name')); ?></a><?php get_template_part('template-parts/college-logo-header'); ?>
                </h1>
                ...
                <div class="available-time">
                    ...
                    <ul class="header-contact">
                        ...
                        <li>
                            <a href="<?php echo $google_map_label ?>" title="Library location"><i
