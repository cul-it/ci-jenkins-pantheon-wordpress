...
<body <?php body_class(); ?>>
	...
	<section class="<?php if ( is_front_page() ) { echo 'hero__content'; } else { echo 'hero__content interior-pages'; } ?>" aria-label="Hero header">
		...
		<div class="all-libraries" role="region" aria-label="Main library site, all library hours, and contact links">
			<a href="https://www.library.cornell.edu/"><i class="fas fa-arrow-left" aria-hidden="true"></i> ALL LIBRARIES</a> | <a href="https://www.library.cornell.edu/libraries"><span> Hours</a></span> | <a href="https://www.library.cornell.edu/ask/email"><span>Ask a Librarian</span></a>
		</div>
