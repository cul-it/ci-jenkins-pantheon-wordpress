...
.s-lc-whw-head-date { color: #000; }
.s-lc-whw-today-h, .s-lc-whw-today {  background-color: #5b5b5b; }
...
.s-lc-whw-pr, .s-lc-whw-ne{ padding: 5px 10px; font-size: 12px; line-height: 1.5; border-radius: 3px; color: #5b5b5b; background-color: #fff; border-color: #5b5b5b; display: inline-block; margin-bottom: 0; font-weight: 400; text-align: center; vertical-align: middle; cursor: pointer; background-image: none; border: 1px solid transparent; white-space: nowrap; }
.s-lc-whw-pr:hover, .s-lc-whw-ne:hover { color: #fff; background-color: #5b5b5b; }
.s-lc-whw-pr:disabled { background-color: #efefef; display: none; }
.s-lc-whw-ne:disabled { background-color: #efefef; display: none; }
