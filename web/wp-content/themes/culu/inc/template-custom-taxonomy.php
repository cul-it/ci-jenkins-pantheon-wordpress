...
function cptui_register_my_staff()
{
    ...
    /**
     * Taxonomy: Languages expertise.
     */

    $labels = [
        "name" => __("Language of Expertise", "culu"),
        "singular_name" => __("Language of Expertise", "culu"),
    ];

    $args = [
        "label" => __("Language of Expertise", "culu"),
        "labels" => $labels,
        "public" => true,
        "publicly_queryable" => true,
        "hierarchical" => false,
        ...
        "show_in_nav_menus" => true,
        "query_var" => true,
        "rewrite" => ['slug' => 'language_expertise', 'with_front' => true,],
        "show_admin_column" => false,
        "show_in_rest" => true,
        "rest_base" => "language_expertise",
        "rest_controller_class" => "WP_REST_Terms_Controller",
        "show_in_quick_edit" => false,
    ];
    register_taxonomy("language_expertise", ["staff"], $args);
}
