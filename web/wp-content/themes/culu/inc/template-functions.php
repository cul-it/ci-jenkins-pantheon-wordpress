...
function vue_bundled_assets() {
  ...
  wp_register_script(
    'vue-software-list',
    get_stylesheet_directory_uri() . '/vue/dist/js/software.js', // for development: 'http://localhost:8080/js/software.js'.
    array(),
    false,
    true
  );
  ...
  wp_register_script(
    'vue-vendors-chunk',
    get_stylesheet_directory_uri() . '/vue/dist/js/chunk-vendors.js', // for development: 'http://localhost:8080/js/chunk-vendors.js'.
    array(),
    false,
    true
  );
