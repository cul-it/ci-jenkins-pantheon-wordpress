...
function culu_random_staff($atts)
{
    ...
    if ($the_query->have_posts()) {
        while ($the_query->have_posts()) {
            ...
            $anchor_name = "/staff-profiles/#" . $post->post_name;
            ...
            $display_random_profile .= "<h3><a href='$anchor_name'>$name</a></h3><h4>$title</h4>";
            ...
            $display_random_profile .= "<p class='all-staff'><a href='/staff-profiles/'>All staff »</a></p>";
